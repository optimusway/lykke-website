      ...
      <Row>
        <Col xs={12} sm={6} md={3}>
          ...
          <MainText className="text-grey">
            Contribute to the future of finance. Here we invite open discussion
            for everyone that is interested in what the next generation of
            finance holds and how we can get there.
          </MainText>
        </Col>
        <Col xs={12} md={9}>
          <News>
