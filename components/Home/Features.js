  ...
  @media all and (min-width: 768px) {
    ...
    &:first-child {
      border-radius: ${p => p.theme.corners.primary}
        ${p => p.theme.corners.primary} 0 0;
    }

    &:last-child {
      border-radius: 0 0 ${p => p.theme.corners.primary}
        ${p => p.theme.corners.primary};
    }
              ...
              <Col xs={12} sm={6} md={6}>
                <Accordion>
                  ...
                  >
                    <AccordionImage className="d-md-none">
                      <img
                        src="/static/images/feature-02-mobile.png"
                        alt=""
                        width="261px"
                      />
                    </AccordionImage>
                  ...
                  >
                    <AccordionImage className="d-md-none">
                      <img
                        src="/static/images/feature-03-mobile.png"
                        alt=""
                        width="311px"
                      />
                    </AccordionImage>
