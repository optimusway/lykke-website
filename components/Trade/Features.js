  ...
  <Section>
    <Grid className="container">
      <SectionHeader>
        ...
        <p>
          Lykke Trade offers a seamless user interface,
          a robust API and a host of other professional tools for best-in-class trading experience.
        </p>
      </SectionHeader>
      ...
      <TabSlider>
        <Row>
          ...
          <Col xs={12} sm={6} md={7} className="d-none d-md-block">
            <SliderImages>
              <img src="/static/images/feature-hero-01.png" alt="" width="688px"/>
              <img src="/static/images/feature-trade-02.png" alt="" width="628px" style={{display: 'none'}}/>
              <img src="/static/images/feature-trade-03.png" alt="" width="626px" style={{display: 'none'}}/>
            </SliderImages>
          </Col>
        </Row>
      </TabSlider>
